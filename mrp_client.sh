...
confirm_rating()     { curl_json PUT "/api/ratings/${RATING_ID}/confirm" | pp_json; }
...
mark_favorite()      { curl_json POST   "/api/favorites/${MEDIA_ID}" | pp_json; }
unmark_favorite()    { curl_json DELETE "/api/favorites/${MEDIA_ID}" | pp_json; }
